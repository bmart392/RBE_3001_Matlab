...
%             
%             quiver3(endposition2(1),endposition2(2),endposition2(3),endeffector_force_xyz(1),...
%                 endeffector_force_xyz(2),endeffector_force_xyz(3),'LineWidth',5);
%             
%             %             set(Robot.handle2,'XData',vertex1(1),'YData',vertex1(2),...
%             %                 'ZData',vertex1(3),'UData',endeffector_force_xyz(1)*1000,'VData',...
%             %                 endeffector_force_xyz(2)*1000,'WData',endeffector_force_xyz(3)*1000);
...
%        case POINT3
            ...
            quiver3(endposition3(1),endposition3(2),endposition3(3),...
                endeffector_force_xyz(1), endeffector_force_xyz(2),...
                endeffector_force_xyz(3),'LineWidth',5);
