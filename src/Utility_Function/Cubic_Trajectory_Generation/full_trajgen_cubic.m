...
%
% ----- VERSION 1 -----
%   FUNCTION CALL: full_trajgen_cubic(version, vertices, ...
...
function trajectory = full_trajgen_cubic(version, vertices, ...
    time_elapsed, abbreviated_numsteps, ...
        ...
        for j = 1:num_dimensions
            ...
            for k = 1:num_vertices-1
                ...
                if(k ~= num_vertices-1)
                    ...
                    positions = gentraj_interpolation_cubic(ASSUMED_START_TIME,...
