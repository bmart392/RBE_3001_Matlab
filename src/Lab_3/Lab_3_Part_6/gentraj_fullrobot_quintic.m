...
% characteristics. 
trajectory(:,1) = gentraj_interpolation(joint1_pointcharacteristics(1),...
...
% characteristics. 
trajectory(:,2) = gentraj_interpolation(joint2_pointcharacteristics(1),...
...
% characteristics. 
trajectory(:,3) = gentraj_interpolation(joint3_pointcharacteristics(1), ...
