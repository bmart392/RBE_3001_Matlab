...
try
    ...
    for m = 1:5
        ...
        for i = 1:10
            ...
            coordinates = kinematics(readings);
            % put in matrix
            jointmatrix(i, (4*m)-3) = time;
            jointmatrix(i, (4*m)-2)   = coordinates(4,1);
            jointmatrix(i, (4*m)-1) = coordinates(4,2);
            jointmatrix(i, 4*m) = coordinates(4,3);
        end
