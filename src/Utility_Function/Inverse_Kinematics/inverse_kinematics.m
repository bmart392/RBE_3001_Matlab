...
radiansToDegrees = 180 / pi;    % Radians to degrees conversion
...
theta1min = -85;    % In degrees

theta2max = 85;  % The should be all the way up
theta2min = -25; % This is the lowest the shoulder can go. 
