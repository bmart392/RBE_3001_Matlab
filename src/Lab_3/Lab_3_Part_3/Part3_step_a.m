%% Part 3a: Move to two points using inverse kinematics
% Moves the robot to the chosen random task space
% locations and arm joints.
...
try
    ...
    numsamples = 150;   % Number of times the arm position is sampled
    ...
    % Matrix that holds all the joint angles.
