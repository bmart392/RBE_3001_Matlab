...
% create a triangle in 3D task space using linear interpolation
...
try
    ...
    % Each path is a 3x12 matrix of end effector positions
    ...
    % Each path is a 3x12 matrix of joint angles
    ...
    % Iterate through the columns in full_path
    for w = 1:36
